...
export const strings = {
  pt: {
    ...
    social: {
      ...
      notifActivity: 'atividade da sua rede',
      notifEmpty: 'tudo em dia! nenhuma novidade por aqui.',
      sent: 'enviado',
      ...
      profile: {
        ...
        mod: {
          ...
          unblock: 'desbloquear',
          report: 'denunciar',
          reportTitle: 'motivo da denúncia',
          reasons: { spam: 'spam', abuse: 'assédio / abuso', inappropriate: 'conteúdo impróprio', fake: 'perfil falso', other: 'outro' },
          reportDone: 'denúncia enviada. obrigado.',
  ...
  en: {
    ...
    social: {
      ...
      notifActivity: "your network's activity",
      notifEmpty: 'all caught up! nothing new here.',
      sent: 'sent',
      ...
      profile: {
        ...
        mod: {
          ...
          unblock: 'unblock',
          report: 'report',
          reportTitle: 'reason for report',
          reasons: { spam: 'spam', abuse: 'harassment / abuse', inappropriate: 'inappropriate content', fake: 'fake profile', other: 'other' },
